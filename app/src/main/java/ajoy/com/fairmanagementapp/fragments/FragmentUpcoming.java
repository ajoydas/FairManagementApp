...
import  ajoy.com.fairmanagementapp.adapters.AdapterMovies;
...
import  ajoy.com.fairmanagementapp.extras.MovieSorter;
...
import  ajoy.com.fairmanagementapp.task.TaskLoadUpcomingMovies;
...
public class FragmentUpcoming extends Fragment implements SortListener, UpcomingMoviesLoadedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (savedInstanceState != null) {
            ...
            mListMovies = MyApplication.getWritableDatabaseMovie().readMovies(DBMovies.UPCOMING);
