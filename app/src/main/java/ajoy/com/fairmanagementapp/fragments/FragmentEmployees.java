 ...
 */
public class FragmentEmployees extends Fragment implements/* AsyncResponse,*/ EmployeeLoadedListener, SwipeRefreshLayout.OnRefreshListener  {

    private static final String STATE_EMPLOYEES = "state_employees";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(R.layout.fragment_employees, container, false);

        SearchView searchView = (SearchView) layout.findViewById(R.id.searchViewEmployee);
        ...
        RecyclerView mRecyclerEmployees = (RecyclerView) layout.findViewById(R.id.listEmployees);
...
public void onSaveInstanceState(Bundle outState) {
    ...
    outState.putParcelableArrayList(STATE_EMPLOYEES, mListEmployees);
}
